...
def init_parser(alg):
    ...
    if alg == 'WOLP_DDPG':
        ...
        parser.add_argument('--max-episode-length', type=int, default=10000, metavar='M', help='maximum length of an episode (default: 1440)')
        ...
        parser.add_argument('--max-episode', type=int, default=10, help='maximum #episode.')
        parser.add_argument('--test-episode', type=int, default=10000, help='maximum testing #episode.')
        ...
        parser.add_argument('--save_per_epochs', default=1, type=int, help='save model every X epochs')
