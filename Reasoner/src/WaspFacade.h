...
class WaspFacade
{
    public:
        ...
        inline void decrementFrozenClauses() { solver.decrementFrozenClauses(); }
        inline int getNbNotFrozenClauses() {return solver.getNbNotFrozenClauses();}
        inline Solver::ClauseIterator learnedClauses_begin() { return solver.learnedClauses_begin(); }
        inline Solver::ClauseIterator learnedClauses_end() { return solver.learnedClauses_end(); }
        inline Solver::ClauseReverseIterator learnedClauses_rbegin() { return solver.learnedClauses_rbegin(); }
        inline Solver::ClauseReverseIterator learnedClauses_rend() { return solver.learnedClauses_rend(); }
        inline void deleteLearnedClause(Solver::ClauseIterator iterator) { solver.deleteLearnedClause(iterator); }
        inline Reason* getImplicant(Var v) { return solver.getImplicant(v); }
